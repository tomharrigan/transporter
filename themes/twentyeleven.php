 ...
 */
function twenty_eleven_infinite_transporter_init() {
	add_theme_support( 'infinite-transporter', array(
		'container' => 'content',
		'footer'    => 'page',
	) );
}
add_action( 'init', 'twenty_eleven_infinite_transporter_init' );

/**
 * Enqueue CSS stylesheet with theme styles for infinity.
 */
function twenty_eleven_infinite_transporter_enqueue_styles() {
...
add_action( 'wp_enqueue_scripts', 'twenty_eleven_infinite_transporter_enqueue_styles', 25 );
...
add_filter( 'infinite_transporter_has_footer_widgets', 'twenty_eleven_has_footer_widgets' );
