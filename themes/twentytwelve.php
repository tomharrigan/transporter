 ...
 */
function twenty_twelve_infinite_transporter_init() {
	add_theme_support( 'infinite-transporter', array(
		'container'      => 'content',
		'footer'         => 'page'
	) );
}
add_action( 'after_setup_theme', 'twenty_twelve_infinite_transporter_init' );

/**
 * Enqueue CSS stylesheet with theme styles for infinity.
 */
function twenty_twelve_infinite_transporter_enqueue_styles() {
...
add_action( 'wp_enqueue_scripts', 'twenty_twelve_infinite_transporter_enqueue_styles', 25 );
 ...
 * @filter infinite_transporter_has_footer_widgets
 * @return bool
 */
...
add_filter( 'infinite_transporter_has_footer_widgets', 'twenty_twelve_has_footer_widgets' );