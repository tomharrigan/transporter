...
add_action( 'after_setup_theme', 'twentyfourteen_infinite_transporter_init' );
...
if ( function_exists( 'jetpack_is_mobile' ) ) {
	...
	add_filter( 'infinite_transporter_has_footer_widgets', 'twentyfourteen_has_footer_widgets' );
}
...
add_action( 'wp_enqueue_scripts', 'twentyfourteen_infinite_transporter_enqueue_styles', 25 );